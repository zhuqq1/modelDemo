 ...
 * @File:tree组件
 * @add:添加获取半勾选状态的节点
 * @Date: 2017-12-01 13:44:27 
 * @Last Modified by:   zhuqq 
 */
<script>
export default {
  name: "tree",
  ...
  methods: {
    ...
    getHarfChecked(){
     let currentArr = [];
      this.treeData.forEach(function(element) {
          if ((element.childNode && element.childNode.length) && (element.ishalfChecked || element.isChecked)) {
            currentArr.push(JSON.parse(JSON.stringify(element)));
          }
      }, this);
      return currentArr;
